...
export default function DebugPage() {
  useEffect(() => {
    ...
    console.log('Firebase Variables:', Object.keys(envVars).filter(key => key.startsWith('NEXT_PUBLIC_FIREBASE_')))
    console.groupEnd()
  }, [])
  ...
  return (
    <div className="p-4">
      ...
      <p className="text-gray-600">Note: Only NEXT_PUBLIC_ variables are visible on the client side.</p>
    </div>
  )
}
